...
public class BaseJettyJerseyController extends BaseJettyController {
	 ...
	 */
	// private String containerIncludeJarPattern =
	// classPathBaseAbsolute(getClass());
	...
	// public void setContainerIncludeJarPattern(String
	// containerIncludeJarPattern) {
	...
	// String classPathRelative = packageNameTest.replace(".", "/") + "/" +
	// classFileName;
	// String classPathBaseAbsolute = classPathAbsolute.substring(0,
	// classPathAbsolute.lastIndexOf(classPathRelative));
