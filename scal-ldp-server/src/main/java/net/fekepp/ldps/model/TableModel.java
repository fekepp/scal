...
import net.fekepp.ldps.format.CsvFormat;
...
public class TableModel implements Model {
	...
	private static Format DEFAULT_FORMAT = TsvFormat.getInstance();

	private static Set<Format> FORMATS = Sets.newHashSet(DEFAULT_FORMAT, CsvFormat.getInstance());

	private static class InstanceHolder {
		static final TableModel INSTANCE = new TableModel();
	}
